          ...
          <ScrollView className='w-full h-full'>
            <View className="mt-4 px-4">
              <View className="w-full mb-2 border-b-[1px] border-gray-300">
                ...
                <Text className="text-lg font-Pretendard-Medium">힐링허브는 회원님의 환하게 웃는 모습을 기대하며 최고의 제품을 최저가로 공급합니다</Text>
              </View>
              <View className="w-full mb-2 border-b-[1px] border-gray-300">
              ...
              <View className="w-full border-b-[1px] border-gray-300">
                ...
                <Text className="text-lg font-Pretendard-Medium">- 1호선 동대문역 8번출구, 종로 5가역 6번출구 {"\n"}- 2호선, 3호선, 5호선, 4호선 동대문역사문화공원역 14번 출구</Text>
